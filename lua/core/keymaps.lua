...
vim.keymap.set('n', '<leader>rb', globals.run_project, { desc = 'Run build script' })
vim.keymap.set('n', '<leader>rB', ':!build.bat', { desc = 'Run build script' })
vim.keymap.set('n', '<leader>rf', globals.run_current_file, { desc = 'Run build script of current file' })
